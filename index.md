...
[CRU CL v. 2.0 climatology
data](https://crudata.uea.ac.uk/~timm/grid/CRU_CL_2_0.html) into R,
facilitates the calculation of minimum temperature and maximum
temperature, and formats the data into a
[data.table](https://CRAN.R-project.org/package=data.table) or a
[terra::SpatRaster](https://CRAN.R-project.org/package=terra) object.
...
arc minutes (0.1666667 degree) resolution. For more information see the
...
> diurnal temperature range, relative humidity, sunshine duration,
> ground frost frequency and windspeed - and was interpolated from a
> data set of station means for the period centred on 1961 to 1990.
> Precipitation was first defined in terms of the parameters of the
> Gamma distribution, enabling the calculation of monthly precipitation
> at any given return period. The data are compared to an earlier data
> set at 0.5 degrees latitude/longitude resolution and show added value
> over most regions. The data will have many applications in applied
...
> Institute “World Water and Climate Atlas” (<https://www.iwmi.org/>)
> and the Climatic Research Unit
> (<https://www.uea.ac.uk/groups-and-centres/climatic-research-unit>).

### Other

- Please [report any issues or
  bugs](https://codeberg.org/ropensci/getCRUCLdata/issues).
